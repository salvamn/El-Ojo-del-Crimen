...
Esta aplicación permite extraer, descifrar y visualizar las credenciales almacenadas localmente en el equipo del usuario, usando técnicas que ilustran cómo un programa con permisos estándar puede acceder a datos sensibles. Además, simula la exfiltración de dicha información a un backend remoto (Firebase Realtime Database), evidenciando el riesgo real de fuga de datos en escenarios maliciosos.
